...
namespace Maze
{
    ...
    public class SmoothRect : IEquatable<SmoothRect>
    {
        ...
        /// <summary>
        /// True if X, Y, Width, Height are the exact same.
        /// </summary>
        public override bool Equals(object obj)
        {
            return obj is SmoothRect objCasted && Equals(objCasted);
        }
        ...
        /// <summary>
        /// Returns true if the point lies on or within the rectangle bounds.
        /// </summary>
        public static bool ContainsPoint(SmoothRect rect1, Point point)
        {
            return
                point.X >= rect1.X &&
                point.X <= rect1.Right &&
        ...
        /// Returns true if the point lies on or within the rectangle bounds.
        /// </summary>
        public static bool ContainsPoint(SmoothRect rect1, Vector2 point)
        {
            return
                point.X >= rect1.X &&
                point.X <= rect1.Right &&
