...
namespace Maze
{
    ...
    public class MazeStairs : GameObj
    {
        ...
        {
            MazeStairs newBlock = new(game, X, Y, Layer);
        ...
        public override void Update()
        {
            ...
            //Gets a list of all actors, enemies and crates on the stairs object.
            ...
            foreach (GameObj item in items)
            {
                ...
                itemsDest = itemsDest.Where(o => !(o.BlockType == Type.MultiWay &&
                    o.IsEnabled && ((o.SlotValueInt1 == 0 && o.BlockDir == item.BlockDir) ||
                ...
                for (int i = itemsDest.Count - 1; i >= 0; i--)
                {
                    ...
                    if (itemsDest[i].BlockType == Type.Crate)
                    {
                        ...
                        itemsFront = itemsFront.Where(o => !(o.IsEnabled &&
                            o.BlockType == Type.MultiWay && ((o.SlotValueInt1 == 0 &&
                            o.BlockDir == item.BlockDir) || (o.SlotValueInt1 != 0 &&
